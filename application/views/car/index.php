            ...
            <div class="col-sm-12 col-xl-8 offset-xl-2 py-5">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Car Contacts</h3>
                        
                        <a href="<?php echo base_url('car/add');?>" class="btn btn-success btn-send pull-right"><i class="fa fa-fw fa-plus-circle"></i>Add New</a>
                    </div>
                    <div class="box-body">
                            ...
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $contact['models'];?></td>
                                        
                                        <td>
                                            <a title="Edit" href="<?php echo base_url('car/edit/').$contact['id'];?>"><i class="fa fa-fw fa-edit"></i></a>
                                            <a title="Delete" href="javascript:void(0)" class="deleteRow" id="<?php echo $contact['id'];?>"><i class="fa fa-fw fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
...
<script>
    ...
    function deleteRow(id,thisObj){
        ...
        .then((willDelete) => {
          if (willDelete) {
              $.ajax({
                  url : "<?php echo base_url('car/deleteRow');?>",
                  type : "post",
                  data :{ 'id' : id},
                  success : function(){
