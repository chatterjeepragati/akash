                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            $curModel = $model['model']."-".$model['no_of_seat']."-".$model['type'];
                                            ?>
                                            <span class="roomTypes">
                                            <label>
                                                <input type="checkbox" class="minimal" name="models[]" value="<?php echo $model['model'];?>-<?php echo $model['no_of_seat'];?>-<?php echo $model['type'];?>" <?php echo in_array($curModel, $contacts['models']) ? 'checked' : ''; ?>>
                                            </label>
